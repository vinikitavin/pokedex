<template>
  <form>
    <div class="poke-attack">
      ...
      <div class="poke-attack__content" :style="{ display: display }">
...
.poke-attack__select-box select {
  width: 100%;
  height: 21px;
